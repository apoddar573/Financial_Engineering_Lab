...
for (i in seq(1:len_x)) {
	temp_values[i] = binomialPricing(X[i], K, T, r, sigma, M, 0, 0);
}
# print(temp_values);
...
temp_values = matrix(0, len_x);
for (i in seq(1:len_x)) {
	temp_values[i] = binomialPricing(X[i], K, T, r, sigma, M, 1, 0);
}
# print(temp_values);
...
temp_values = matrix(0, len_x);
for (i in seq(1:len_x)) {
	temp_values[i] = binomialPricing(X[i], K, T, r, sigma, M, 0, 1);
}
# print(temp_values);
...
temp_values = matrix(0, len_x);
for (i in seq(1:len_x)) {
	temp_values[i] = binomialPricing(X[i], K, T, r, sigma, M, 1, 1);
}
# print(temp_values);
...
temp_values = matrix(0, len_x);
for (i in seq(1:len_x)) {
	temp_values[i] = binomialPricing(S_O, X[i], T, r, sigma, M, 0, 0);
}
# print(temp_values);
...
temp_values = matrix(0, len_x);
for (i in seq(1:len_x)) {
	temp_values[i] = binomialPricing(S_O, X[i], T, r, sigma, M, 1, 0);
}
# print(temp_values);
...
temp_values = matrix(0, len_x);
for (i in seq(1:len_x)) {
	temp_values[i] = binomialPricing(S_O, X[i], T, r, sigma, M, 0, 1);
}
# print(temp_values);
jpeg("Put_SetA_K.jpg")
...
temp_values = matrix(0, len_x);
for (i in seq(1:len_x)) {
	temp_values[i] = binomialPricing(S_O, X[i], T, r, sigma, M, 1, 1);
}
# print(temp_values);
jpeg("Put_SetB_K.jpg")
...
temp_values = matrix(0, len_x);
for (i in seq(1:len_x)) {
	temp_values[i] = binomialPricing(S_O, K, T, X[i], sigma, M, 0, 0);
}
# print(temp_values);
...
temp_values = matrix(0, len_x);
for (i in seq(1:len_x)) {
	temp_values[i] = binomialPricing(S_O, K, T, X[i], sigma, M, 1, 0);
}
# print(temp_values);
...
temp_values = matrix(0, len_x);
for (i in seq(1:len_x)) {
	temp_values[i] = binomialPricing(S_O, K, T, X[i], sigma, M, 0, 1);
}
# print(temp_values);
jpeg("Put_SetA_r.jpg")
...
temp_values = matrix(0, len_x);
for (i in seq(1:len_x)) {
	temp_values[i] = binomialPricing(S_O, K, T, X[i], sigma, M, 1, 1);
}
# print(temp_values);
jpeg("Put_SetB_r.jpg")
...
temp_values = matrix(0, len_x);
for (i in seq(1:len_x)) {
	temp_values[i] = binomialPricing(S_O, K, T, r, X[i], M, 0, 0);
}
# print(temp_values);
...
temp_values = matrix(0, len_x);
for (i in seq(1:len_x)) {
	temp_values[i] = binomialPricing(S_O, K, T, r, X[i], M, 1, 0);
}
# print(temp_values);
...
temp_values = matrix(0, len_x);
for (i in seq(1:len_x)) {
	temp_values[i] = binomialPricing(S_O, K, T, r, X[i], M, 0, 1);
}
# print(temp_values);
...
temp_values = matrix(0, len_x);
for (i in seq(1:len_x)) {
	temp_values[i] = binomialPricing(S_O, K, T, r, X[i], M, 1, 1);
}
# print(temp_values);
...
for (i in seq(1:len_x)) {
	temp_values[i] = binomialPricing(S_O, K, T, r, sigma, X[i], 0, 0);
}
# print(temp_values);
for (i in seq(1:len_x)) {
	temp_values1[i] = binomialPricing(S_O, 95, T, r, sigma, X[i], 0, 0);
}
# print(temp_values1);
for (i in seq(1:len_x)) {
	temp_values2[i] = binomialPricing(S_O, 105, T, r, sigma, X[i], 0, 0);
}
# print(temp_values2);
...
temp_values2 = matrix(0, len_x);
for (i in seq(1:len_x)) {
	temp_values[i] = binomialPricing(S_O, K, T, r, sigma, X[i], 1, 0);
}
for (i in seq(1:len_x)) {
	temp_values1[i] = binomialPricing(S_O, 95, T, r, sigma, X[i], 1, 0);
}
for (i in seq(1:len_x)) {
	temp_values2[i] = binomialPricing(S_O, 105, T, r, sigma, X[i], 1, 0);
}
# print(temp_values)
...
temp_values2 = matrix(0, len_x);
for (i in seq(1:len_x)) {
	temp_values[i] = binomialPricing(S_O, K, T, r, sigma, X[i], 0, 1);
}
for (i in seq(1:len_x)) {
	temp_values1[i] = binomialPricing(S_O, 95, T, r, sigma, X[i], 0, 1);
}
for (i in seq(1:len_x)) {
	temp_values2[i] = binomialPricing(S_O, 105, T, r, sigma, X[i], 0, 1);
}
# print(temp_values);
...
temp_values2 = matrix(0, len_x);
for (i in seq(1:len_x)) {
	temp_values[i] = binomialPricing(S_O, K, T, r, sigma, X[i], 1, 1);
}
for (i in seq(1:len_x)) {
	temp_values[i] = binomialPricing(S_O, 95, T, r, sigma, X[i], 1, 1);
}
for (i in seq(1:len_x)) {
	temp_values[i] = binomialPricing(S_O, 105, T, r, sigma, X[i], 1, 1);
}
# print(temp_values);
